...
build-all-binaries:
    WORKDIR /binaries
    COPY github.com/rishikesavanramesh/SWERVE-DRIVE:master+swerve-bot-humble-packages/build-bed/*.deb .
    COPY github.com/rishikesavanramesh/ar100:humble+ar100/*.deb .
